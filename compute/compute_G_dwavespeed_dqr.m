function [ dspeeddq ] = compute_G_dwavespeed_dqr(ql,qr,quadpoint,data)
...
dspeeddq_tilde(3,:) = problem_G_drho_dq(qr,quadpoint,data);
dspeeddq_tilde(2,:) = problem_G_drho_dq(qa,quadpoint,data)/2;
dspeeddq_tilde(1,:) = problem_G_drho_dq(ql,quadpoint,data).*0;
