function [ dspeeddq ] = compute_H_dwavespeed_dql(ql,qr,quadpoint,data)
...
dspeeddq_tilde(3,:) = problem_H_drho_dq(qr,quadpoint,data).*0;
dspeeddq_tilde(2,:) = problem_H_drho_dq(qa,quadpoint,data)/2;
dspeeddq_tilde(1,:) = problem_H_drho_dq(ql,quadpoint,data);
