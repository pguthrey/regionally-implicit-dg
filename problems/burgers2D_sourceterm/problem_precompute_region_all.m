function [Jacobian,residual] = problem_precompute_region_all(DGregion,data,~)
...
Jacobian(indices(1),indices(1)) =   Jac_cell_11 + ...
                                    ...
                                    Jac_nort_flux_11 + ... 
                                    Jac_sout_trunc_11 ;
Jacobian(indices(1),indices(2)) = Jac_east_flux_11;
Jacobian(indices(1),indices(4)) = Jac_nort_flux_11;
