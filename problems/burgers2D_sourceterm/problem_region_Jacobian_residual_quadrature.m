function [Jacobian,residual] = problem_region_Jacobian_residual_quadrature(DGregion,DGregion_past,auxiliary,data)
...
switch data.predictor_quadrature
    case 'quadrature_free_volumes'
        switch data.M
            case 2
                [Jac_cell_11,residual_cell_11] = problem_jac_res_init_quadfree_M2_Q(q1,q1_past,nuv1,nuv2);
                [Jac_cell_21,residual_cell_21] = problem_jac_res_init_quadfree_M2_Q(q2,q2_past,nuv1,nuv2);
                [Jac_cell_31,residual_cell_31] = problem_jac_res_init_quadfree_M2_Q(q3,q3_past,nuv1,nuv2);
                [Jac_cell_12,residual_cell_12] = problem_jac_res_init_quadfree_M2_Q(q4,q4_past,nuv1,nuv2);
                [Jac_cell_22,residual_cell_22] = problem_jac_res_init_quadfree_M2_Q(q5,q5_past,nuv1,nuv2);
                [Jac_cell_32,residual_cell_32] = problem_jac_res_init_quadfree_M2_Q(q6,q6_past,nuv1,nuv2);
                [Jac_cell_13,residual_cell_13] = problem_jac_res_init_quadfree_M2_Q(q7,q7_past,nuv1,nuv2);
                [Jac_cell_23,residual_cell_23] = problem_jac_res_init_quadfree_M2_Q(q8,q8_past,nuv1,nuv2);
                [Jac_cell_33,residual_cell_33] = problem_jac_res_init_quadfree_M2_Q(q9,q9_past,nuv1,nuv2);
            case 4
    ...
    otherwise
        error(' Invalid predictor_quadrature ')
end
...
for k = 1:Pd
    ...
    residual_cell_31 = residual_cell_31 + psieT*(F3_p*wgtnuv1);
    residual_cell_32 = residual_cell_32 + psieT*(F6_p*wgtnuv1);
    residual_cell_33 = residual_cell_33 + psieT*(F9_p*wgtnuv1);

    Jac_cell_31 = Jac_cell_31 + psikpsim_ee*(DF3_pDq*wgtnuv1);
    Jac_cell_32 = Jac_cell_32 + psikpsim_ee*(DF6_pDq*wgtnuv1);
    Jac_cell_33 = Jac_cell_33 + psikpsim_ee*(DF9_pDq*wgtnuv1);      
    
    residual_cell_11 = residual_cell_11 - psiwT*(F1_m*wgtnuv1);
    residual_cell_12 = residual_cell_12 - psiwT*(F4_m*wgtnuv1);
    residual_cell_13 = residual_cell_13 - psiwT*(F7_m*wgtnuv1);
    
    Jac_cell_11 = Jac_cell_11 - psikpsim_ww*(DF1_mDq*wgtnuv1);
    Jac_cell_12 = Jac_cell_12 - psikpsim_ww*(DF4_mDq*wgtnuv1);
    Jac_cell_13 = Jac_cell_13 - psikpsim_ww*(DF7_mDq*wgtnuv1);
    ...
    residual_cell_11 = residual_cell_11 + psieT*Flux;
    residual_cell_21 = residual_cell_21 - psiwT*Flux;
    Jac_cell_11 = Jac_cell_11 + psikpsim_ee*F_dql; 
    Jac_east_othr_11 = Jac_east_othr_11 + psikpsim_ew*F_dqr;    
    Jac_cell_21 = Jac_cell_21 - psikpsim_ww*F_dqr; 
    ...
    residual_cell_21 = residual_cell_21 + psieT*Flux;
    residual_cell_31 = residual_cell_31 - psiwT*Flux;
    Jac_cell_21 = Jac_cell_21 + psikpsim_ee*F_dql; 
    Jac_east_othr_21 = Jac_east_othr_21 + psikpsim_ew*F_dqr; 
    Jac_cell_31 = Jac_cell_31 - psikpsim_ww*F_dqr; 
    ...
    residual_cell_12 = residual_cell_12 + psieT*Flux;
    residual_cell_22 = residual_cell_22 - psiwT*Flux;
    Jac_cell_12 = Jac_cell_12 + psikpsim_ee*F_dql; 
    Jac_east_othr_12 = Jac_east_othr_12 + psikpsim_ew*F_dqr; 
    Jac_cell_22 = Jac_cell_22 - psikpsim_ww*F_dqr; 
    ...
    residual_cell_22 = residual_cell_22 + psieT*Flux;
    residual_cell_32 = residual_cell_32 - psiwT*Flux;
    F_dql = (DF5_pDq + speed)*wgtnuv1/2;
    F_dqr = (DF6_mDq - speed)*wgtnuv1/2;
    Jac_cell_22 = Jac_cell_22 + psikpsim_ee*F_dql; 
    Jac_east_othr_22 = Jac_east_othr_22 + psikpsim_ew*F_dqr; 
    Jac_cell_32 = Jac_cell_32 - psikpsim_ww*F_dqr; 
    ...
    residual_cell_13 = residual_cell_13 + psieT*Flux;
    residual_cell_23 = residual_cell_23 - psiwT*Flux;
    Jac_cell_13 = Jac_cell_13 + psikpsim_ee*F_dql; 
    Jac_east_othr_13 = Jac_east_othr_13 + psikpsim_ew*F_dqr; 
    Jac_cell_23 = Jac_cell_23 - psikpsim_ww*F_dqr; 
    ...
    residual_cell_23 = residual_cell_23 + psieT*Flux;
    residual_cell_33 = residual_cell_33 - psiwT*Flux;
    Jac_cell_23 = Jac_cell_23 + psikpsim_ee*F_dql; 
    Jac_east_othr_23 = Jac_east_othr_23 + psikpsim_ew*F_dqr;    
    Jac_cell_33 = Jac_cell_33 - psikpsim_ww*F_dqr; 
    Jac_west_othr_33 = Jac_west_othr_33 - psikpsim_we*F_dql; 
        
    residual_cell_13 = residual_cell_13 + psinT*(F7_n*wgtnuv2);
    residual_cell_23 = residual_cell_23 + psinT*(F8_n*wgtnuv2);
    residual_cell_33 = residual_cell_33 + psinT*(F9_n*wgtnuv2);
    
    Jac_cell_13 = Jac_cell_13 + psikpsim_nn*(DF7_nDq*wgtnuv2);
    Jac_cell_23 = Jac_cell_23 + psikpsim_nn*(DF8_nDq*wgtnuv2);
    Jac_cell_33 = Jac_cell_33 + psikpsim_nn*(DF9_nDq*wgtnuv2);      
    
    residual_cell_11 = residual_cell_11 - psisT*(F1_s*wgtnuv2);
    residual_cell_21 = residual_cell_21 - psisT*(F2_s*wgtnuv2);
    residual_cell_31 = residual_cell_31 - psisT*(F3_s*wgtnuv2);
    
    Jac_cell_11 = Jac_cell_11 - psikpsim_ss*(DF1_sDq*wgtnuv2);
    Jac_cell_21 = Jac_cell_21 - psikpsim_ss*(DF2_sDq*wgtnuv2);
    Jac_cell_31 = Jac_cell_31 - psikpsim_ss*(DF3_sDq*wgtnuv2);
    ...
    residual_cell_11 = residual_cell_11 + psinT*Flux;
    residual_cell_12 = residual_cell_12 - psisT*Flux;
    Jac_cell_11 = Jac_cell_11 + psikpsim_nn*F_dql;    
    Jac_nort_othr_11 = Jac_nort_othr_11 + psikpsim_ns*F_dqr;    
    Jac_cell_12 = Jac_cell_12 - psikpsim_ss*F_dqr;    
    ...
    residual_cell_21 = residual_cell_21 + psinT*Flux;
    residual_cell_22 = residual_cell_22 - psisT*Flux;
    Jac_cell_21 = Jac_cell_21 + psikpsim_nn*F_dql;    
    Jac_nort_othr_21 = Jac_nort_othr_21 + psikpsim_ns*F_dqr;      
    Jac_cell_22 = Jac_cell_22 - psikpsim_ss*F_dqr;    
    ...
    residual_cell_31 = residual_cell_31 + psinT*Flux;
    residual_cell_32 = residual_cell_32 - psisT*Flux;
    Jac_cell_31 = Jac_cell_31 + psikpsim_nn*F_dql;    
    Jac_nort_othr_31 = Jac_nort_othr_31 + psikpsim_ns*F_dqr;     
    Jac_cell_32 = Jac_cell_32 - psikpsim_ss*F_dqr;    
    ...
    residual_cell_12 = residual_cell_12 + psinT*Flux;
    residual_cell_13 = residual_cell_13 - psisT*Flux;
    Jac_cell_12 = Jac_cell_12 + psikpsim_nn*F_dql;    
    Jac_nort_othr_12 = Jac_nort_othr_12 + psikpsim_ns*F_dqr;    
    Jac_cell_13 = Jac_cell_13 - psikpsim_ss*F_dqr;    
    ...
    residual_cell_22 = residual_cell_22 + psinT*Flux;
    residual_cell_23 = residual_cell_23 - psisT*Flux;
    Jac_cell_22 = Jac_cell_22 + psikpsim_nn*F_dql;    
    Jac_nort_othr_22 = Jac_nort_othr_22 + psikpsim_ns*F_dqr;     
    Jac_cell_23 = Jac_cell_23 - psikpsim_ss*F_dqr;    
    ...
    residual_cell_32 = residual_cell_32 + psinT*Flux;
    residual_cell_33 = residual_cell_33 - psisT*Flux;
    F_dql = (DF6_nDq + speed)*wgtnuv2/2;
    F_dqr = (DF9_sDq - speed)*wgtnuv2/2;
    Jac_cell_32 = Jac_cell_32 + psikpsim_nn*F_dql;
    Jac_nort_othr_32 = Jac_nort_othr_32 + psikpsim_ns*F_dqr;
    Jac_cell_33 = Jac_cell_33 - psikpsim_ss*F_dqr;
...
residual = zeros(thetaT,1);
Jacobian = zeros(thetaT);
...
residual(indices_1,1) =   residual_cell_11 ;                                
residual(indices_2,1) =   residual_cell_21 ;
residual(indices_3,1) =   residual_cell_31 ;                               
residual(indices_4,1) =   residual_cell_12 ;
residual(indices_5,1) =   residual_cell_22 ;
residual(indices_6,1) =   residual_cell_32 ;
residual(indices_7,1) =   residual_cell_13 ;                                
residual(indices_8,1) =   residual_cell_23 ;
residual(indices_9,1) =   residual_cell_33 ;


%{
Jacobian(indices_1,indices_1) = Jac_cell_11;
Jacobian(indices_1,indices_2) = Jac_east_othr_11;
Jacobian(indices_1,indices_4) = Jac_nort_othr_11;                                
Jacobian(indices_2,indices_1) = Jac_west_othr_21;
Jacobian(indices_2,indices_2) = Jac_cell_21;
Jacobian(indices_2,indices_3) = Jac_east_othr_21;
Jacobian(indices_2,indices_5) = Jac_nort_othr_21;   
Jacobian(indices_3,indices_2) = Jac_west_othr_31;
Jacobian(indices_3,indices_3) = Jac_cell_31;
Jacobian(indices_3,indices_6) = Jac_nort_othr_31;          
Jacobian(indices_4,indices_1) = Jac_sout_othr_12;
Jacobian(indices_4,indices_4) = Jac_cell_12;
Jacobian(indices_4,indices_5) = Jac_east_othr_12;
Jacobian(indices_4,indices_7) = Jac_nort_othr_12;                                           
Jacobian(indices_5,indices_2) = Jac_sout_othr_22;
Jacobian(indices_5,indices_4) = Jac_west_othr_22;
Jacobian(indices_5,indices_5) = Jac_cell_22;
Jacobian(indices_5,indices_6) = Jac_east_othr_22;
Jacobian(indices_5,indices_8) = Jac_nort_othr_22;                        
Jacobian(indices_6,indices_3) = Jac_sout_othr_32;
Jacobian(indices_6,indices_5) = Jac_west_othr_32;
Jacobian(indices_6,indices_6) = Jac_cell_32;
Jacobian(indices_6,indices_9) = Jac_nort_othr_32;
Jacobian(indices_7,indices_4) = Jac_sout_othr_13;
Jacobian(indices_7,indices_7) = Jac_cell_13;
Jacobian(indices_7,indices_8) = Jac_east_othr_13;          
Jacobian(indices_8,indices_5) = Jac_sout_othr_23;
Jacobian(indices_8,indices_7) = Jac_west_othr_23;
Jacobian(indices_8,indices_8) = Jac_cell_23;
Jacobian(indices_8,indices_9) = Jac_east_othr_23;
Jacobian(indices_9,indices_6) = Jac_sout_othr_33;
Jacobian(indices_9,indices_8) = Jac_west_othr_33;                        
Jacobian(indices_9,indices_9) = Jac_cell_33;


Jacobian(indices_8,[indices_5 indices_7 indices_8 indices_9]) = [Jac_sout_othr_23 Jac_west_othr_23 Jac_cell_23 Jac_east_othr_23];
