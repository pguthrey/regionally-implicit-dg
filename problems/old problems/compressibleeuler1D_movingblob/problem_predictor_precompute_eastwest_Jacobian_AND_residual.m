...
for k = 1:Pd
    ...
    dcdq = gmma*gm1*0.5/c*orho*[-E*orho-rho*u2 m 1];
    dspeeddq_star = [abs(u) sign(u) 0]*orho + dcdq;    
    ...
    if r_param > 0
        ...
        dcdq = gmma*gm1*0.5/c*orho*[-E*orho-rho*u2 m 1];
        dspeeddq_east = [abs(u) sign(u) 0]*orho + dcdq;   
    ...
    if r_param > 0
        ...
        dspeeddq_west = [abs(u) sign(u) 0]*orho + dcdq;       
