function [data] = VM1D2V_makegif(fcoeffs,E1coeffs,A1coeffs,A2coeffs,tnow,data,nstep)
...
data.VMplotname{3} = 'Electric Field 2';
data.VMplotname{4} = 'Magnetic Field 3';
...
eqn = 1;
    ...
    view(3)
    axis([data.x_lb data.x_ub data.v1_lb data.v1_ub data.vmboundsplot(eqn,:)])
    colorbar
    title([data.VMplotname{eqn} ' , t = ' num2str(tnow)],'FontSize',font)        
    shading interp
    xlabel(['x_1 N = ' num2str(data.Nx)],'FontSize',font)
