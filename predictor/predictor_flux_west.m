function [residual,maxspeed] = predictor_flux_west(qstar,qwest,data,cellcenter)
...
for k = 1:data.Pdm1
    ...
    wwest = data.vectphi_east(:,:,v1quad,v2quad)*qwest;
    ...
    [ Flux,speed] = predictor_F_numerical_Flux(wwest,wstar,quadpoint,data.appdata);
