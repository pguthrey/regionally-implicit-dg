function [update,update_index,Kmax] = initialize_linear_update(data)
...
pickv2 = 10;
 ...
 for k = 1:9
    things = (k-1)*data.thetaT + (1:data.thetaT);
    predictor_update_new(:,:,k,1) = predictor_update(:,things,pickv1,pickv2);
 end
corrector_update_new = corrector_update(:,:,:,pickv1,pickv2)
update_new = update(:,:,:,pickv1,pickv2)
 LHSinv_matlab = inv(LHS_matlab);

DGPUP(1,1,1)=0.000000;DGPUP(1,1,2)=0.036683;DGPUP(1,1,3)=0.030768;DGPUP(1,1,4)=0.000000;DGPUP(1,1,5)=0.139500;DGPUP(1,1,6)=0.043042;DGPUP(1,1,7)=0.000000;DGPUP(1,1,8)=0.000000;DGPUP(1,1,9)=0.000000;DGCUP(1,1,1)=-0.415001;DGCUP(1,1,2)=0.000000;DGCUP(1,1,3)=0.754687;DGCUP(1,1,4)=-0.411697;DGCUP(1,1,5)=0.000000;DGUP(1,1,1)=0.000000;DGUP(1,1,2)=0.000000;DGUP(1,1,3)=-0.055019;DGUP(1,1,4)=-0.045880;DGUP(1,1,5)=0.000000;DGUP(1,1,6)=0.000000;DGUP(1,1,7)=0.000000;DGUP(1,1,8)=-0.131518;DGUP(1,1,9)=-0.052239;DGUP(1,1,10)=-0.045515;DGUP(1,1,11)=0.000000;DGUP(1,1,12)=0.000000;DGUP(1,1,13)=0.421116;DGUP(1,1,14)=-0.082259;DGUP(1,1,15)=-0.080446;DGUP(1,1,16)=0.000000;DGUP(1,1,17)=0.000000;DGUP(1,1,18)=0.000000;DGUP(1,1,19)=0.000000;DGUP(1,1,20)=0.000000;DGUP(1,1,21)=0.000000;DGUP(1,1,22)=0.000000;DGUP(1,1,23)=0.000000;DGUP(1,1,24)=0.000000;DGUP(1,1,25)=0.000000;
predictor_update_new-DGPUP 
corrector_update_new-DGCUP 
update_new-DGUP 
clc
LHS-LHS_matlab
LHSinv-LHSinv_matlab
keyboard 
value=0.000000;value=0.036683;value=0.030768;value=0.000000;value=0.139500;value=0.043042;value=0.000000;value=0.000000;value=0.000000;
