function [ temp ] = DGeval_3D(DGcoeffs,vpoint,data)
...
domainv3 = data.v3_ub - data.v3_lb;
...
v3tilde = v3 - (ceil((v3-data.v3_lb)/domainv3)-1)*domainv3;
indexv3 = ceil((v3tilde - data.v3_lb)/data.deltav3);
etav3 = 2*(v3tilde-data.v3centers(indexv3))/data.deltav3;

zeta = zeros(1,data.theta);
quadpoint = [etav1,etav2,etav3];
...
coeffs = DGcoeffs(:,indexv1,indexv2,indexv3);
temp = zeta*coeffs;
